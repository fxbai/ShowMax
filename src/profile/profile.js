...
function customConfirm(message, callback) {
    ...
    dialog.innerHTML = `<h3 style="margin:0 0 16px 0;color:#fff;">Confirm</h3>
        ...
        <div style="display:flex;gap:10px;justify-content:flex-end;">
            <button id="custom-confirm-cancel" style="padding:10px 20px;background:#2d2d4e;border:none;border-radius:8px;color:#fff;cursor:pointer;font-weight:600;">Cancel</button>
            <button id="custom-confirm-ok" style="padding:10px 20px;background:#ff4757;border:none;border-radius:8px;color:#fff;cursor:pointer;font-weight:600;">Delete</button>
        </div>`;
